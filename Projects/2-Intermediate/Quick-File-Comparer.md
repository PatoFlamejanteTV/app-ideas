...
-   [ ] Read folders and get list of files. Sort file names and match with files from other folder.
-   [ ] Read files from the folders.
-   [ ] Compare rows and column for similar files.
...
-   [ ] Check data types of datae column
-   [ ] Generate report in case of success stading files matched. Show number of rows compared.
